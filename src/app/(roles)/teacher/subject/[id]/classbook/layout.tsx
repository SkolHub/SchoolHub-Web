...
import SelectableItemsListStudents from '@/components/selectable-items-list-students';
...
export default function Classbook({
  ...
  const students = useGetStudents(id);
  ...
  function onSelect(index: number) {
    ...
    // router.push(
    //   `/teacher/subject/${id}/classbook/${students.data[index].student.id}`
    // );
  }
